...
describe(@"Initialization tests", ^{
    ...
    __block SDLTlcControlData *someTlcData = [[SDLTlcControlData alloc] init];
    ...
    it(@"should properly initialize init", ^{
        ...
        expect(testStruct.tlcControlData).to(beNil());
    ...
    it(@"should properly initialize initWithDictionary", ^{
        ...
        NSMutableDictionary* dict = [@{SDLRPCParameterNameModuleType:SDLModuleTypeRadio,
                                       ...
                                       SDLRPCParameterNameTlcControlData:someTlcData,
...
#pragma clang diagnostic pop
        ...
        expect(testStruct.tlcControlData).to(equal(someTlcData));
    ...
    it(@"Should set and get correctly", ^{
        ...
        testStruct.tlcControlData = someTlcData;
    ...
    it(@"Should get correctly when initialized with ObsshControlData", ^ {
        SDLModuleData* testStruct = [[SDLModuleData alloc] initWithObsshControlData:someObsshData];

        expect(testStruct.moduleType).to(equal(SDLModuleTypeObssh));
        expect(testStruct.climateControlData).to(beNil());
        expect(testStruct.radioControlData).to(beNil());
        expect(testStruct.audioControlData).to(beNil());
        expect(testStruct.lightControlData).to(beNil());
    ...
    it(@"Should get correctly when initialized with TlcControlData", ^ {
        SDLModuleData* testStruct = [[SDLModuleData alloc] initWithTlcControlData:someTlcData];

        expect(testStruct.moduleType).to(equal(SDLModuleTypeTlc));
        expect(testStruct.climateControlData).to(beNil());
        expect(testStruct.radioControlData).to(beNil());
        expect(testStruct.audioControlData).to(beNil());
        expect(testStruct.lightControlData).to(beNil());
